  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <div className='text-center'>
        <div className='flex flex-col gap-5 my-10 container mx-auto px-4 py-16'>
          ...
          <section className="mb-8">
            <h2 className="text-3xl font-semibold text-black mb-4 text-center">How It Works</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="flex flex-col items-center bg-gray-100 p-6 rounded-lg shadow-xl hover:scale-105 transition-all duration-300">
          ...
          <section className="mb-8">
            <h2 className="text-3xl font-semibold text-black mb-4">Why Refer?</h2>
            <div className="flex flex-col sm:flex-row justify-center gap-8 mb-8">
              <div className="flex flex-col items-center bg-gray-100 p-8 rounded-lg shadow-lg hover:scale-105 transition-all duration-300">
          ...
          <section className="mb-8">
            <h2 className="text-3xl font-semibold text-black mb-4 text-center">Success Stories</h2>
            <div className="flex justify-center gap-8">
              <div className="w-full sm:w-80 bg-gray-100 p-6 rounded-lg shadow-lg hover:scale-105 transition-all duration-300">
          ...
          <section className="mt-4">
            <h3 className="text-2xl text-black font-bold mb-4">Ready to Start Referring?</h3>
            <p className="text-gray-700 mb-6">Sign up today and start earning rewards for each successful referral!</p>
