...
function Footer() {
  return (
    <footer className="bg-gradient-to-r from-red-300 to-orange-800 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center text-white">
          <div className="mb-4 md:mb-0 text-center md:text-left">
            <h2 className="text-lg font-bold">Jobs&ReferralBridge</h2>
            <p className="text-sm mt-2">© 2024 Your Company. All rights reserved.</p>
          </div>
          
          {/* Social Media Icons */}
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="https://facebook.com" className="hover:text-white transition-all duration-300" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="hover:text-white transition-all duration-300" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="hover:text-white transition-all duration-300" aria-label="LinkedIn">
